import { Center, Heading, VStack, Button, useDisclosure } from '@chakra-ui/react';
  ...
  return (
    <Center mt="150px">
      ...
      <VStack spacing="50px">
        ...
        {/* paypal thing */}
        {auth.isLoggedIn ? (
          <Button size="lg" colorScheme={'purple'} variant="outline" onClick={onOpen}>
            Haz click para donar al servidor
          </Button>
        ) : (
          <Button size="lg" colorScheme={'purple'} variant="outline" onClick={() => history.push('/auth/login')}>
        ...
        <VStack spacing="10px" maxHeight={'600px'} overflowY="scroll" p="20px">
